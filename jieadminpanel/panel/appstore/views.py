...
# def setup(request):
#     AppsInfo.objects.all().delete()
#     AppsInfo.objects.create(
#         icon='system_network.png',
#         module_name='module_system',
#         category='systemtools',
#         name_en='system_network',
#         name_cn='网络配置',
#         author='官方',
#         dev_type=1,
#         dependent='module_system',
#         version='0.0.1-a',
#         status=1,
#         description='管理系统里的网络网卡设置',
#     )
#     AppsInfo.objects.create(
#         icon='system_firewalld.png',
#         module_name='module_system',
#         category='systemtools',
#         name_en='system_firewalld',
#         name_cn='防火墙',
#         author='官方',
#         dev_type=1,
#         dependent='module_system',
#         version='0.0.1-a',
#         status=1,
#         description='管理系统防火墙的端口等设置',
#     )
#     AppsInfo.objects.create(
#         icon='system_services.png',
#         module_name='module_system',
#         category='systemtools',
#         name_en='system_services',
#         name_cn='系统服务',
#         author='官方',
#         dev_type=1,
#         dependent='module_system',
#         version='0.0.1-a',
#         status=1,
#         description='管理开机系统服务',
#     )
#     AppsInfo.objects.create(
#         icon='system_process.png',
#         module_name='module_system',
#         category='systemtools',
#         name_en='system_process',
#         name_cn='进程管理',
#         author='官方',
#         dev_type=1,
#         dependent='module_system',
...
#     )
#     AppsInfo.objects.create(
#         icon='envs_python.png',
#         module_name='module_envs',
#         category='environments',
#         name_en='envs_python',
#         name_cn='Python环境',
#         author='官方',
#         dev_type=1,
#         dependent='module_envs',
#         version='0.0.1-a',
#         status=1,
#         description='管理系统python环境',
#     )
#     AppsInfo.objects.create(
#         icon='db_mysql.png',
#         module_name='module_database',
#         category='database',
#         name_en='db_mysql',
#         name_cn='MySQL管理',
#         author='官方',
#         dev_type=1,
#         dependent='module_database',
#         version='0.0.1-a',
#         status=1,
